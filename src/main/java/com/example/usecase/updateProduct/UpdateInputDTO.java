...
public class UpdateInputDTO {
    ...
    public UpdateInputDTO(int maMh, String name, int price, String category, int quantity, String dvt, Date nSX,
    ...
    public UpdateInputDTO(int maMh, String name, int price, String category, int quantity, String dvt,String nhaSanXuat, Date ngayNhapKho) {
       this(maMh, name, price, category, quantity, dvt);
